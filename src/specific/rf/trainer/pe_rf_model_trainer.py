...
class RfPeModelTrainer:

    # Build a random forest classifier. It contains both model and algorithm to train it. OO design.
    def get_random_forest_classifier(self, args):
    ...
    # Build a random forest classifier from the training set (ml_features, ml_label).
