...
class CbstPeEvaluateOutputArgs:
    ...
    def __init__(self, output_dir: str):
        ...
        self.out_json = os.path.join(output_dir, 'cbst_test_metrics.json')
        self.out_md = os.path.join(output_dir, 'cbst_test_summary.md')
        self.out_png = os.path.join(output_dir, 'cbst_confusion_matrix.png')
