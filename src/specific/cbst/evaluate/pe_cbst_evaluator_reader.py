...
class CbstPeEvaluatorReader:
    """Reader for CatBoost model and evaluation data.
    
    Handles reading CatBoost models from joblib files and CSV data.
    ...
    def read_cbst_model_from_joblib_file(self, args_in):
        """Read CatBoost model from joblib file.
