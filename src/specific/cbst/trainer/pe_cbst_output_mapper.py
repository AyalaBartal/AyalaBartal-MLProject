...
from src.specific.cbst.trainer.pe_cbst_train_args import CbstPeTrainArgs
from src.specific.cbst.trainer.pe_cbst_train_result import CbstPeTrainResult


class CbstPeOutputMapper:
    """Map training results to output format."""

    def get_end_message(self, result: CbstPeTrainResult):
    ...
    def get_report(self, args, result: CbstPeTrainResult):
