...
class CbstPeOutputWriter:
    ...
    def write_model_to_joblib_file(self, out_file, cbst_model):
        """Serialize CatBoost model using joblib."""
        joblib.dump(cbst_model, out_file)
    ...
    def write_feature_importance_to_csv(self, out_file, feature_names, cbst_model):
        """Write feature importance scores to CSV file."""
        feature_importance = pd.DataFrame({
            "feature": feature_names,
            "importance": cbst_model.feature_importances_
