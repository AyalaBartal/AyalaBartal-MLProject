...
class LgbPeEvaluatorCalculator:
    """Metrics calculator for LightGBM evaluation.
    ...
    @staticmethod
    def get_report_from_y_prob_pred(y, prob, pred) -> LgbPeEvaluateReport:
        ...
        Returns:
            LgbPeEvaluateReport with AUC, accuracy, and confusion matrix.
        """
        auc = roc_auc_score(y, prob)
        acc = accuracy_score(y, pred)
        cm = confusion_matrix(y, pred)
        return LgbPeEvaluateReport(auc, acc, cm)
