...
class LgbPeReportTrainer:
    """Report generation and confusion matrix calculation."""

    def __init__(self, row_selector: LgbPeDataTrainer, matrix_builder: LgbPeModelTrainer):
        ArgsValidator.require_type_not_none(row_selector, LgbPeDataTrainer, "row_selector")
        ArgsValidator.require_type_not_none(matrix_builder, LgbPeModelTrainer, "matrix_builder")
    ...
    def get_report(self, args, ml_features, model, con_matrix, scores):
        ...
        return LgbPeTrainResult(args, ml_features, model, con_matrix, scores['test_accuracy'], scores['test_roc_auc'])
