...
class XgbPeEvaluatorWriter:
    """Writer for XGBoost evaluation results.
    
    Orchestrates writing evaluation metrics, summaries, and confusion matrix plots
    to various output formats (JSON, Markdown, PNG).
    """

    def __init__(self, formatter: XgbPeEvaluatorFormatter, file_writer: FileWriter, plot_writer: MlIoPlotWriter):
