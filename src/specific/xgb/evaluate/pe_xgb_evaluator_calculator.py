...
class XgbPeEvaluatorCalculator:
    """Metrics calculator for XGBoost evaluation.
    ...
    @staticmethod
    def get_report_from_y_prob_pred(y, prob, pred) -> XgbPeEvaluateReport:
        ...
        Returns:
            XgbPeEvaluateReport with AUC, accuracy, and confusion matrix.
        """
        auc = roc_auc_score(y, prob)
        acc = accuracy_score(y, pred)
        cm = confusion_matrix(y, pred)
        return XgbPeEvaluateReport(auc, acc, cm)
