...
from src.specific.xgb.trainer.pe_xgb_train_args import XgbPeTrainArgs
from src.specific.xgb.trainer.pe_xgb_train_result import XgbPeTrainResult


class XgbPeOutputMapper:
    """Map training results to output format."""

    def get_end_message(self, result: XgbPeTrainResult):
    ...
    def get_report(self, args, result: XgbPeTrainResult):
