...
"""
Ordered integration test for ML decision-tree flow.
...
class TestPePdIntegration(unittest.TestCase):
    ...
    def test_03_preprocessor(self):
        ...
        dt_pe_csv_preprocessor = DtPeCsvPreprocessMapper(DtPePreprocessorProvider.get_mapper())
    ...
    def test_04_trainer(self):
        ...
        report_args = DtPeTrainReportArgs(self.state.output_preprocess_csv_file, self.state.output_train_dir_path)
    ...
    def test_05_evaluate(self):
        ...
        input_args = DtPeEvaluateInputArgs(self.state.output_train_dir_path)
        ...
        output_args = DtPeEvaluateOutputArgs(self.state.output_evaluate_dir_path)
...
def suite():
    ...
    test_suite.addTest(TestPePdIntegration("test_01_input_validation"))
    test_suite.addTest(TestPePdIntegration("test_02_input_cleanup"))
    test_suite.addTest(TestPePdIntegration("test_03_preprocessor"))
    test_suite.addTest(TestPePdIntegration("test_04_trainer"))
    test_suite.addTest(TestPePdIntegration("test_05_evaluate"))
    return test_suite
