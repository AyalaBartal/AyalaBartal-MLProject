...
class TestCbstPeModelTrainer(unittest.TestCase):
    ...
    def test_get_lightgbm_classifier_returns_expected_model(self):
        ...
        self.assertIsInstance(model, (LgbPeModelTrainer.__bases__[0] if hasattr(LgbPeModelTrainer, '__bases__') else object))
