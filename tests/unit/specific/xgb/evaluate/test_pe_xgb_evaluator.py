...
from src.specific.xgb.evaluate.pe_xgb_evaluate_algo_args import XgbPeEvaluateAlgoArgs
from src.specific.xgb.evaluate.pe_xgb_evaluate_output_args import XgbPeEvaluateOutputArgs
from src.specific.xgb.evaluate.pe_xgb_evaluate_report import XgbPeEvaluateReport


class TestXgbPeDataEvaluator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.evaluator = XgbPeDataEvaluator(
            reader=self.reader,
    ...
    def test_evaluate_calls_all_dependencies_with_expected_args(self):
        args_in = XgbPeEvaluateInputArgs("input_dir")
        args_al = XgbPeEvaluateAlgoArgs()
        args_out = XgbPeEvaluateOutputArgs("output_dir")
        ...
        prob = sentinel.prob
        pred = sentinel.pred
        report = XgbPeEvaluateReport(auc=0.91, acc=0.85, cm=[[10, 2], [3, 15]])

        self.reader.read_csv_to_df.return_value = df
        self.reader.read_xgb_model_from_joblib_file.return_value = model
        ...
        self.reader.read_xgb_model_from_joblib_file.assert_called_once_with(args_in)
    ...
    def test_evaluate_calls_reader_in_expected_order(self):
        ...
        self.reader.read_xgb_model_from_joblib_file.return_value = sentinel.model
        ...
        self.assertEqual(
            ...
            [
                ...
                call.read_xgb_model_from_joblib_file(args_in),
            ]
        )
    ...
    def test_evaluate_stops_when_validate_input_raises(self):
        ...
        self.reader.read_xgb_model_from_joblib_file.assert_not_called()
    ...
    def test_evaluate_stops_when_reader_raises(self):
        args_in = XgbPeEvaluateInputArgs("input_dir")
        args_al = XgbPeEvaluateAlgoArgs()
        args_out = XgbPeEvaluateOutputArgs("output_dir")

        self.reader.validate_output.side_effect = IOError("bad output path")
    ...
    def test_evaluate_propagates_threshold_to_calculator(self):
        args_in = XgbPeEvaluateInputArgs("input_dir")
        args_al = XgbPeEvaluateAlgoArgs()
        args_al.threshold = 0.7
        args_out = XgbPeEvaluateOutputArgs("output_dir")
        ...
        # Verify threshold passed to calculator
        call_args = self.calculator.get_pred_from_prob_threshold.call_args
