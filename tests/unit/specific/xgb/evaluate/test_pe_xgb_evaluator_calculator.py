...
from src.specific.xgb.evaluate import XgbPeEvaluateReport
...
class TestXgbPeEvaluatorCalculator(unittest.TestCase):
    ...
    def test_get_input_from_data_label_returns_df_without_label_column(self):
        ...
        actual = XgbPeEvaluatorCalculator.get_input_from_data_label(args_al, df)
    ...
    def test_get_output_from_data_label_returns_label_values(self):
        ...
        actual = XgbPeEvaluatorCalculator.get_output_from_data_label(args_al, df)
    ...
    def test_get_prob_from_model_x_returns_positive_class_probability_when_predict_proba_exists(self):
        ...
        actual = XgbPeEvaluatorCalculator.get_prob_from_model_x(model, x)
    ...
    def test_get_pred_from_prob_threshold_returns_binary_predictions(self):
        ...
        actual = XgbPeEvaluatorCalculator.get_pred_from_prob_threshold(proba, threshold)
    ...
    def test_get_report_from_y_prob_pred_returns_expected_report(self):
        ...
        actual = XgbPeEvaluatorCalculator.get_report_from_y_prob_pred(y, prob, pred)

        self.assertIsInstance(actual, XgbPeEvaluateReport)
    ...
    def test_get_report_from_y_prob_pred_calculates_confusion_matrix(self):
        ...
        self.assertEqual(actual.cm[0, 0], 2)  # True negatives
        self.assertEqual(actual.cm[1, 1], 2)  # True positives
