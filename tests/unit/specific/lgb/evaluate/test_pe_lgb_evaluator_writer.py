...
class TestLgbPeEvaluatorWriter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.writer = LgbPeEvaluatorWriter(
    ...
    def test_write_out_md_calls_formatter_and_file_writer(self):
        ...
        md_text = "# LightGBM Evaluation Report\n\nAUC: 0.92\nAccuracy: 0.88"
    ...
    def test_write_out_json_with_different_threshold(self):
        out_json = "output.json"
        threshold = 0.7
        report = LgbPeEvaluateReport(auc=0.85, acc=0.82, cm=np.array([[8, 3], [2, 13]]))
