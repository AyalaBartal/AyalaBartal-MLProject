...
class TestLgbPeDataEvaluator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.evaluator = LgbPeDataEvaluator(
            reader=self.reader,
    ...
    def test_evaluate_calls_all_dependencies_with_expected_args(self):
        args_in = LgbPeEvaluateInputArgs("input_dir")
        args_al = LgbPeEvaluateAlgoArgs()
        args_out = LgbPeEvaluateOutputArgs("output_dir")
        ...
        prob = sentinel.prob
        pred = sentinel.pred
        report = LgbPeEvaluateReport(auc=0.91, acc=0.85, cm=[[10, 2], [3, 15]])

        self.reader.read_csv_to_df.return_value = df
        self.reader.read_lgb_model_from_joblib_file.return_value = model
        ...
        self.reader.read_lgb_model_from_joblib_file.assert_called_once_with(args_in)
    ...
    def test_evaluate_calls_reader_in_expected_order(self):
        ...
        self.reader.read_lgb_model_from_joblib_file.return_value = sentinel.model
        ...
        self.assertEqual(
            ...
            [
                ...
                call.read_lgb_model_from_joblib_file(args_in),
            ]
        )
    ...
    def test_evaluate_stops_when_validate_input_raises(self):
        ...
        self.reader.read_lgb_model_from_joblib_file.assert_not_called()
