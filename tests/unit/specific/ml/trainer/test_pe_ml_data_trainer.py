...
class TestMlPeDataTrainer(unittest.TestCase):

    def setUp(self):
        self.trainer = MlPeDataTrainer()
    ...
    def test_select_train_test_returns_correct_row_order(self):
        train_idx = [3, 1]
        test_idx = [0]
        ...
        self.assertEqual(test_df.shape[0], 1)
        self.assertEqual(train_df.iloc[0]["feature1"], 4)
        self.assertEqual(test_df.iloc[0]["feature1"], 1)
